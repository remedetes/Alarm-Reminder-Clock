	...
	<div id="wrapper">
		...
		<section id="content">
			<div class="container">
				<div class="row">
					<div class="col-lg-8">
						<h3 class="widgetheading">Sejarah PUSDIKLAT ANRI</h3><hr>
						<article>
						<b>PUSAT PENDIDIKAN DAN PELATIHAN KEARSIPAN (PUSDIKLAT)</b><br>
							<p align="justify">
						...
						<p align="justify">
								...
								Meningkatkan dan mengembangkan keterampilan di bidang kearsipan, sehingga setelah mengikuti diklat diharapkan dapat memberikan kontribusi bagi organisasi untuk mencapai efektivitas dan efisiensi kerja.<br><br>
							</p>
						</article>
						<div class="clear"></div>
					</div>
