	...
	<div id="wrapper">
		...
		<section id="content">
			<div class="container">
				<div class="row">
					<div class="col-lg-8">
						<h3 class="widgetheading">Tugas Dan Fungsi</h3><hr>
						<article>
							<p>
								<p align="justify">
								Tugas, fungsi dan struktur organisasi Pusdiklat Kearsipan ANRI tercantum
dalam Peraturan Kepala ANRI Nomor 14 Tahun 2014 tentang Organisasi dan
Tata Kerja Arsip Nasional Republik Indonesia <br>
1.3.1. Tugas: menyusun program dan melaksanakan pendidikan dan
pelatihan bagi aparatur di bidang kearsipan.<br>
1.3.2. Fungsi:<br>
1.3.2.1. Penyusunan kebijakan teknis, rencana, dan program di bidang
pendidikan dan pelatihan kearsipan;<br>
1.3.2.2. Pelaksanaan tugas di bidang pendidikan dan pelatihan
kearsipan;<br>
1.3.2.3. Pemantauan, evaluasi, dan pelaporan pelaksanaan tugas di
bidang pendidikan dan pelatihan kearsipan; dan<br>
1.3.2.4. Pelaksanaan urusan ketatausahaan dan pengelolaan arsip
aktif, perlengkapan dan kerumahtanggaan, keuangan dan
kepegawaian.<br>
1.3.3. Struktur: Organisasi Pusdiklat Kearsipan:<br></p>
